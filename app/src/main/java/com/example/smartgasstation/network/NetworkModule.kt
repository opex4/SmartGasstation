package com.example.smartgasstation.network
...
//    private const val BASE_URL = "http://10.0.2.2:8000/"
    ...
    fun provideGasStationApi(context: Context): com.example.smartgasstation.network.api.GasStationApi {
        return provideRetrofit(context).create(com.example.smartgasstation.network.api.GasStationApi::class.java)
    }
